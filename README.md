#INSTRUCTIONS :
Due to CRLF ending nature of windows files, I have found out that tests which include printing of multiline tests(eg:usage,ls command of todo) fails on windows.
I have tested this application on Ubuntu 20.04 Focal Fossa and it works fine.
changed python3 to python in bat file due to some environment variable issues
Contains two files,  todo.py(for windows) and todo(for linux)
There is an image which shows that all test are passed by this program, tested on Ubuntu.
